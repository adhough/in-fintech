...
<br />
<p>
The above examples selected had the strongest correlations in my analysis. It is very difficult to find relationships between economic data and changes in FX rates.  Many movements in FX rates appear random.  With this in mind, I believe that SMEs and individuals holding a portfolio of foreign currencies should manage their FX Risk exposure by using a Value at Risk (VaR) model using the historical simulation method (with over 15 years of FX rate data). I have developed a website with this model (<a href="https://fxriskmodel.herokuapp.com/" target="_blank">https://fxriskmodel.herokuapp.com/</a>) where the user can input their AUD, CAD, CHF, EUR, JPY, NZD & USD asset amounts. The model then returns the value of their portfolio using the close of business FX rates and estimates the worst possible one-day loss of the portfolio using 95% and 99% confidence intervals. ﻿This model is measuring the FX risk and not other risk factors such as equity, interest or credit risk. An extreme event could lead to losses much larger than estimated by this model. Please contact me with any feedback about this website.
</p>
<br />
<p>
<b>Conclusion</b>
