...
<br />
<p>
The first website I built was <a href="https://agile-project-tracker.herokuapp.com/tracker/" target="_blank">https://agile-project-tracker.herokuapp.com/tracker/</a> (enter username ‘demo_user’ and password ‘read_only’ to view) which allows me to track, manage and prioritise my Projects and Tasks (or Epics and Stories). I use this website to manage my projects using Agile project management methodologies.
</p>
<br />
<p>
For my next project, I remembered from working in the Loans Market that there are no free resources on the internet to calculate the Average One Month Libor rate and Cost of Carry. I built an easy to use website (<a href="https://avglibor.herokuapp.com/estimator/" target="_blank">https://avglibor.herokuapp.com/estimator/</a>) which allows users to select a date range, loan amount and loan price. The algorithm then applies calculations on Libor data stored in the database and returns the results to the user. It would be helpful to get more feedback from users (especially from people working in the Loans Market) to help refine the algorithm used in this website.  My next steps will be to improve the user interface, increase the range of dates available (currently from 1st January 2019 to the present date) and also to extend to other currencies (presently just USD).
</p>
<br />
<p>
I keep challenging myself to learn new Python concepts and increase the complexity of the projects I undertake. I am building a securitisation website (<a href="https://secmodel.herokuapp.com/" target="_blank">https://secmodel.herokuapp.com/</a>) using Python along with Numpy and Pandas libraries which will enable users to input data such as coupons rates, prepayments and default amounts and then analyse the impact on the projected cash flows. In the near-future I also want to build projects using Artificial Intelligence models, develop RESTful APIs (representational state transfer application program interface) and learn more JavaScript libraries to develop professional user interfaces.
</p>
<br />
<p>
