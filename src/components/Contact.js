...
function ContactSection() {
  return (
    ...
    <br />
      ...
      <br />
      <br />
      <a class='social-icon-contactlink email' href="mailto:adhough@hotmail.com" target="_top">
        <i class='fas fa-envelope' />
      </a>
      <p><a href="mailto:adhough@hotmail.com" target="_top">  adhough@hotmail.com </a></p>
      <br />
      <br />
      <a
